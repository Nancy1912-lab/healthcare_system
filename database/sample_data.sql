...
('Dr. Rakesh Patel', 15, '9876500001', 'rakesh.patel@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Cardiology'), '$2b$10$De2xg5iWBAqnrcjZ4h8lTug91xJDtWzfM6OMUM6zvD2J9ZLFxOOiS', '12:00 AM to 5:00 AM'),
('Dr. Nidhi Shah', 12, '9876500002', 'nidhi.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Cardiology'), '$2b$10$gcVmllLMeOJnF/tDBcsHq..C2HS2u/xI2dhV8e1eeQDm6nJ/WfFne', '5:00 AM to 10:00 AM'),
('Dr. Mihir Mehta', 10, '9876500003', 'mihir.mehta@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Cardiology'), '$2b$10$En3GZ.9LEpZIuG90M3GORu1vNASij9AVsxM73BKlBkhg.RPR6fnOK', '10:00 AM to 3:00 PM'),
('Dr. Kunal Desai', 9, '9876500004', 'kunal.desai@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Cardiology'), '$2b$10$huGEtitX2FmYuPAtG0bE9uMzpt3rT/5CESuGRfbrqzPlQfyqYmLE.', '3:00 PM to 8:00 PM'),
('Dr. Bhavik Trivedi', 14, '9876500005', 'bhavik.trivedi@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Cardiology'), '$2b$10$7ZfoPYIgL/gqzoVFZtq9pOOhOP6odK/L42iiJ/g5XNRCcEyw1uYDW', '8:00 PM to 12:00 AM'),

-- NEUROLOGY (4)
('Dr. Aakash Joshi', 13, '9876500006', 'aakash.joshi@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Neurology'), '$2b$10$De2xg5iWBAqnrcjZ4h8lTug91xJDtWzfM6OMUM6zvD2J9ZLFxOOiS', '12:00 AM to 6:00 AM'),
('Dr. Pooja Mehta', 9, '9876500007', 'pooja.mehta@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Neurology'), '$2b$10$gcVmllLMeOJnF/tDBcsHq..C2HS2u/xI2dhV8e1eeQDm6nJ/WfFne', '6:00 AM to 12:00 PM'),
('Dr. Hiren Shah', 11, '9876500008', 'hiren.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Neurology'), '$2b$10$En3GZ.9LEpZIuG90M3GORu1vNASij9AVsxM73BKlBkhg.RPR6fnOK', '12:00 PM to 6:00 PM'),
('Dr. Rupal Vyas', 8, '9876500009', 'rupal.vyas@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Neurology'), '$2b$10$huGEtitX2FmYuPAtG0bE9uMzpt3rT/5CESuGRfbrqzPlQfyqYmLE.', '6:00 PM to 12:00 AM'),

-- NEUROSURGERY (3)
('Dr. Sandeep Patel', 16, '9876500010', 'sandeep.patel@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Neurosurgery'), '$2b$10$7ZfoPYIgL/gqzoVFZtq9pOOhOP6odK/L42iiJ/g5XNRCcEyw1uYDW', '12:00 AM to 8:00 AM'),
('Dr. Jinal Shah', 10, '9876500011', 'jinal.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Neurosurgery'), '$2b$10$De2xg5iWBAqnrcjZ4h8lTug91xJDtWzfM6OMUM6zvD2J9ZLFxOOiS', '8:00 AM to 4:00 PM'),
('Dr. Parth Mehta', 12, '9876500012', 'parth.mehta@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Neurosurgery'), '$2b$10$gcVmllLMeOJnF/tDBcsHq..C2HS2u/xI2dhV8e1eeQDm6nJ/WfFne', '4:00 PM to 12:00 AM'),

-- ORTHOPAEDIC & JOINT REPLACEMENT (5)
('Dr. Darshan Patel', 14, '9876500013', 'darshan.patel@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Orthopaedic & Joint Replacement'), '$2b$10$En3GZ.9LEpZIuG90M3GORu1vNASij9AVsxM73BKlBkhg.RPR6fnOK', '12:00 AM to 5:00 AM'),
('Dr. Meet Shah', 11, '9876500014', 'meet.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Orthopaedic & Joint Replacement'), '$2b$10$huGEtitX2FmYuPAtG0bE9uMzpt3rT/5CESuGRfbrqzPlQfyqYmLE.', '5:00 AM to 10:00 AM'),
('Dr. Krunal Desai', 9, '9876500015', 'krunal.desai@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Orthopaedic & Joint Replacement'), '$2b$10$7ZfoPYIgL/gqzoVFZtq9pOOhOP6odK/L42iiJ/g5XNRCcEyw1uYDW', '10:00 AM to 3:00 PM'),
('Dr. Harsh Vyas', 8, '9876500016', 'harsh.vyas@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Orthopaedic & Joint Replacement'), '$2b$10$De2xg5iWBAqnrcjZ4h8lTug91xJDtWzfM6OMUM6zvD2J9ZLFxOOiS', '3:00 PM to 8:00 PM'),
('Dr. Tejas Joshi', 13, '9876500017', 'tejas.joshi@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Orthopaedic & Joint Replacement'), '$2b$10$gcVmllLMeOJnF/tDBcsHq..C2HS2u/xI2dhV8e1eeQDm6nJ/WfFne', '8:00 PM to 12:00 AM'),

-- GASTROENTEROLOGY (5)
('Dr. Ketan Patel', 12, '9876500018', 'ketan.patel@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Gastroenterology'), '$2b$10$En3GZ.9LEpZIuG90M3GORu1vNASij9AVsxM73BKlBkhg.RPR6fnOK', '12:00 AM to 5:00 AM'),
('Dr. Bhumi Shah', 9, '9876500019', 'bhumi.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Gastroenterology'), '$2b$10$huGEtitX2FmYuPAtG0bE9uMzpt3rT/5CESuGRfbrqzPlQfyqYmLE.', '5:00 AM to 10:00 AM'),
('Dr. Ronak Mehta', 10, '9876500020', 'ronak.mehta@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Gastroenterology'), '$2b$10$7ZfoPYIgL/gqzoVFZtq9pOOhOP6odK/L42iiJ/g5XNRCcEyw1uYDW', '10:00 AM to 3:00 PM'),
('Dr. Yash Desai', 7, '9876500021', 'yash.desai@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Gastroenterology'), '$2b$10$De2xg5iWBAqnrcjZ4h8lTug91xJDtWzfM6OMUM6zvD2J9ZLFxOOiS', '3:00 PM to 8:00 PM'),
('Dr. Nikunj Trivedi', 11, '9876500022', 'nikunj.trivedi@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Gastroenterology'), '$2b$10$gcVmllLMeOJnF/tDBcsHq..C2HS2u/xI2dhV8e1eeQDm6nJ/WfFne', '8:00 PM to 12:00 AM'),

-- UROLOGY (5)
('Dr. Dhruv Patel', 13, '9876500023', 'dhruv.patel@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Urology'), '$2b$10$En3GZ.9LEpZIuG90M3GORu1vNASij9AVsxM73BKlBkhg.RPR6fnOK', '12:00 AM to 5:00 AM'),
('Dr. Jigar Shah', 10, '9876500024', 'jigar.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Urology'), '$2b$10$huGEtitX2FmYuPAtG0bE9uMzpt3rT/5CESuGRfbrqzPlQfyqYmLE.', '5:00 AM to 10:00 AM'),
('Dr. Chirag Mehta', 9, '9876500025', 'chirag.mehta@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Urology'), '$2b$10$7ZfoPYIgL/gqzoVFZtq9pOOhOP6odK/L42iiJ/g5XNRCcEyw1uYDW', '10:00 AM to 3:00 PM'),
('Dr. Viral Desai', 8, '9876500026', 'viral.desai@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Urology'), '$2b$10$De2xg5iWBAqnrcjZ4h8lTug91xJDtWzfM6OMUM6zvD2J9ZLFxOOiS', '3:00 PM to 8:00 PM'),
('Dr. Ankit Joshi', 12, '9876500027', 'ankit.joshi@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Urology'), '$2b$10$gcVmllLMeOJnF/tDBcsHq..C2HS2u/xI2dhV8e1eeQDm6nJ/WfFne', '8:00 PM to 12:00 AM'),

-- SURGICAL ONCOLOGY (4)
('Dr. Rajiv Patel', 15, '9876500028', 'rajiv.patel@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Surgical Oncology'), '$2b$10$En3GZ.9LEpZIuG90M3GORu1vNASij9AVsxM73BKlBkhg.RPR6fnOK', '12:00 AM to 6:00 AM'),
('Dr. Neel Shah', 11, '9876500029', 'neel.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Surgical Oncology'), '$2b$10$huGEtitX2FmYuPAtG0bE9uMzpt3rT/5CESuGRfbrqzPlQfyqYmLE.', '6:00 AM to 12:00 PM'),
('Dr. Paresh Mehta', 13, '9876500030', 'paresh.mehta@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Surgical Oncology'), '$2b$10$7ZfoPYIgL/gqzoVFZtq9pOOhOP6odK/L42iiJ/g5XNRCcEyw1uYDW', '12:00 PM to 6:00 PM'),
('Dr. Tushar Desai', 9, '9876500031', 'tushar.desai@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Surgical Oncology'), '$2b$10$De2xg5iWBAqnrcjZ4h8lTug91xJDtWzfM6OMUM6zvD2J9ZLFxOOiS', '6:00 PM to 12:00 AM'),

-- MEDICAL ONCOLOGY (4)
('Dr. Hemal Patel', 14, '9876500032', 'hemal.patel@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Medical Oncology'), '$2b$10$gcVmllLMeOJnF/tDBcsHq..C2HS2u/xI2dhV8e1eeQDm6nJ/WfFne', '12:00 AM to 6:00 AM'),
('Dr. Ritesh Shah', 10, '9876500033', 'ritesh.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Medical Oncology'), '$2b$10$En3GZ.9LEpZIuG90M3GORu1vNASij9AVsxM73BKlBkhg.RPR6fnOK', '6:00 AM to 12:00 PM'),
('Dr. Vimal Mehta', 12, '9876500034', 'vimal.mehta@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Medical Oncology'), '$2b$10$huGEtitX2FmYuPAtG0bE9uMzpt3rT/5CESuGRfbrqzPlQfyqYmLE.', '12:00 PM to 6:00 PM'),
('Dr. Kiran Desai', 8, '9876500035', 'kiran.desai@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Medical Oncology'), '$2b$10$7ZfoPYIgL/gqzoVFZtq9pOOhOP6odK/L42iiJ/g5XNRCcEyw1uYDW', '6:00 PM to 12:00 AM'),

-- RADIATION ONCOLOGY (4)
('Dr. Ajay Patel', 13, '9876500036', 'ajay.patel@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Radiation Oncology'), '$2b$10$De2xg5iWBAqnrcjZ4h8lTug91xJDtWzfM6OMUM6zvD2J9ZLFxOOiS', '12:00 AM to 6:00 AM'),
('Dr. Pankaj Shah', 11, '9876500037', 'pankaj.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Radiation Oncology'), '$2b$10$gcVmllLMeOJnF/tDBcsHq..C2HS2u/xI2dhV8e1eeQDm6nJ/WfFne', '6:00 AM to 12:00 PM'),
('Dr. Sagar Mehta', 10, '9876500038', 'sagar.mehta@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Radiation Oncology'), '$2b$10$En3GZ.9LEpZIuG90M3GORu1vNASij9AVsxM73BKlBkhg.RPR6fnOK', '12:00 PM to 6:00 PM'),
('Dr. Mahesh Desai', 9, '9876500039', 'mahesh.desai@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Radiation Oncology'), '$2b$10$huGEtitX2FmYuPAtG0bE9uMzpt3rT/5CESuGRfbrqzPlQfyqYmLE.', '6:00 PM to 12:00 AM'),

-- OBSTETRICS (4)
('Dr. Nisha Patel', 12, '9876500040', 'nisha.patel@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Obstetrics'), '$2b$10$7ZfoPYIgL/gqzoVFZtq9pOOhOP6odK/L42iiJ/g5XNRCcEyw1uYDW', '12:00 AM to 6:00 AM'),
('Dr. Komal Shah', 9, '9876500041', 'komal.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Obstetrics'), '$2b$10$De2xg5iWBAqnrcjZ4h8lTug91xJDtWzfM6OMUM6zvD2J9ZLFxOOiS', '6:00 AM to 12:00 PM'),
('Dr. Rina Mehta', 11, '9876500042', 'rina.mehta@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Obstetrics'), '$2b$10$gcVmllLMeOJnF/tDBcsHq..C2HS2u/xI2dhV8e1eeQDm6nJ/WfFne', '12:00 PM to 6:00 PM'),
('Dr. Heena Desai', 8, '9876500043', 'heena.desai@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Obstetrics'), '$2b$10$En3GZ.9LEpZIuG90M3GORu1vNASij9AVsxM73BKlBkhg.RPR6fnOK', '6:00 PM to 12:00 AM'),

-- GYNAECOLOGY (4)
('Dr. Bhavna Patel', 13, '9876500044', 'bhavna.patel@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Gynaecology'), '$2b$10$huGEtitX2FmYuPAtG0bE9uMzpt3rT/5CESuGRfbrqzPlQfyqYmLE.', '12:00 AM to 6:00 AM'),
('Dr. Pinal Shah', 10, '9876500045', 'pinal.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Gynaecology'), '$2b$10$7ZfoPYIgL/gqzoVFZtq9pOOhOP6odK/L42iiJ/g5XNRCcEyw1uYDW', '6:00 AM to 12:00 PM'),
('Dr. Minal Mehta', 9, '9876500046', 'minal.mehta@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Gynaecology'), '$2b$10$De2xg5iWBAqnrcjZ4h8lTug91xJDtWzfM6OMUM6zvD2J9ZLFxOOiS', '12:00 PM to 6:00 PM'),
('Dr. Rupal Desai', 11, '9876500047', 'rupal.desai@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Gynaecology'), '$2b$10$gcVmllLMeOJnF/tDBcsHq..C2HS2u/xI2dhV8e1eeQDm6nJ/WfFne', '6:00 PM to 12:00 AM'),

-- PAEDIATRICS (4)
('Dr. Khyati Patel', 10, '9876500048', 'khyati.patel@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Paediatrics'), '$2b$10$En3GZ.9LEpZIuG90M3GORu1vNASij9AVsxM73BKlBkhg.RPR6fnOK', '12:00 AM to 6:00 AM'),
('Dr. Janki Shah', 8, '9876500049', 'janki.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Paediatrics'), '$2b$10$huGEtitX2FmYuPAtG0bE9uMzpt3rT/5CESuGRfbrqzPlQfyqYmLE.', '6:00 AM to 12:00 PM'),
('Dr. Sejal Mehta', 9, '9876500050', 'sejal.mehta@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Paediatrics'), '$2b$10$7ZfoPYIgL/gqzoVFZtq9pOOhOP6odK/L42iiJ/g5XNRCcEyw1uYDW', '12:00 PM to 6:00 PM'),
('Dr. Aarti Desai', 7, '9876500051', 'aarti.desai@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Paediatrics'), '$2b$10$De2xg5iWBAqnrcjZ4h8lTug91xJDtWzfM6OMUM6zvD2J9ZLFxOOiS', '6:00 PM to 12:00 AM'),

-- OPHTHALMOLOGY (4)
('Dr. Devang Patel', 11, '9876500052', 'devang.patel@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Ophthalmology'), '$2b$10$gcVmllLMeOJnF/tDBcsHq..C2HS2u/xI2dhV8e1eeQDm6nJ/WfFne', '12:00 AM to 6:00 AM'),
('Dr. Nayan Shah', 9, '9876500053', 'nayan.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Ophthalmology'), '$2b$10$En3GZ.9LEpZIuG90M3GORu1vNASij9AVsxM73BKlBkhg.RPR6fnOK', '6:00 AM to 12:00 PM'),
('Dr. Rakesh Mehta', 12, '9876500054', 'rakesh.mehta@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Ophthalmology'), '$2b$10$huGEtitX2FmYuPAtG0bE9uMzpt3rT/5CESuGRfbrqzPlQfyqYmLE.', '12:00 PM to 6:00 PM'),
('Dr. Hitesh Desai', 8, '9876500055', 'hitesh.desai@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Ophthalmology'), '$2b$10$7ZfoPYIgL/gqzoVFZtq9pOOhOP6odK/L42iiJ/g5XNRCcEyw1uYDW', '6:00 PM to 12:00 AM'),

-- ENT (4)
('Dr. Jignesh Patel', 10, '9876500056', 'jignesh.patel@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='ENT'), '$2b$10$De2xg5iWBAqnrcjZ4h8lTug91xJDtWzfM6OMUM6zvD2J9ZLFxOOiS', '12:00 AM to 6:00 AM'),
('Dr. Ketan Shah', 9, '9876500057', 'ketan.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='ENT'), '$2b$10$gcVmllLMeOJnF/tDBcsHq..C2HS2u/xI2dhV8e1eeQDm6nJ/WfFne', '6:00 AM to 12:00 PM'),
('Dr. Mayur Mehta', 11, '9876500058', 'mayur.mehta@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='ENT'), '$2b$10$En3GZ.9LEpZIuG90M3GORu1vNASij9AVsxM73BKlBkhg.RPR6fnOK', '12:00 PM to 6:00 PM'),
('Dr. Alpesh Desai', 8, '9876500059', 'alpesh.desai@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='ENT'), '$2b$10$huGEtitX2FmYuPAtG0bE9uMzpt3rT/5CESuGRfbrqzPlQfyqYmLE.', '6:00 PM to 12:00 AM'),

-- DERMATOLOGY (4)
('Dr. Nisha Patel', 9, '9876500060', 'nisha2.patel@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Dermatology'), '$2b$10$7ZfoPYIgL/gqzoVFZtq9pOOhOP6odK/L42iiJ/g5XNRCcEyw1uYDW', '12:00 AM to 6:00 AM'),
('Dr. Ruchi Shah', 7, '9876500061', 'ruchi.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Dermatology'), '$2b$10$De2xg5iWBAqnrcjZ4h8lTug91xJDtWzfM6OMUM6zvD2J9ZLFxOOiS', '6:00 AM to 12:00 PM'),
('Dr. Pooja Mehta', 8, '9876500062', 'pooja2.mehta@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Dermatology'), '$2b$10$gcVmllLMeOJnF/tDBcsHq..C2HS2u/xI2dhV8e1eeQDm6nJ/WfFne', '12:00 PM to 6:00 PM'),
('Dr. Heena Desai', 6, '9876500063', 'heena2.desai@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Dermatology'), '$2b$10$En3GZ.9LEpZIuG90M3GORu1vNASij9AVsxM73BKlBkhg.RPR6fnOK', '6:00 PM to 12:00 AM'),

-- GENERAL SURGERY (2)
('Dr. Bharat Patel', 14, '9876500064', 'bharat.patel@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='General Surgery'), '$2b$10$huGEtitX2FmYuPAtG0bE9uMzpt3rT/5CESuGRfbrqzPlQfyqYmLE.', '12:00 AM to 8:00 AM'),
('Dr. Kalpesh Shah', 10, '9876500065', 'kalpesh.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='General Surgery'), '$2b$10$7ZfoPYIgL/gqzoVFZtq9pOOhOP6odK/L42iiJ/g5XNRCcEyw1uYDW', '8:00 AM to 4:00 PM'),

-- LAPAROSCOPIC SURGERY (2)
('Dr. Vipul Mehta', 11, '9876500066', 'vipul.mehta@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Laparoscopic Surgery'), '$2b$10$De2xg5iWBAqnrcjZ4h8lTug91xJDtWzfM6OMUM6zvD2J9ZLFxOOiS', '12:00 AM to 12:00 PM'),
('Dr. Sanjay Desai', 13, '9876500067', 'sanjay.desai@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Laparoscopic Surgery'), '$2b$10$gcVmllLMeOJnF/tDBcsHq..C2HS2u/xI2dhV8e1eeQDm6nJ/WfFne', '12:00 PM to 12:00 AM'),

-- BARIATRIC SURGERY (2)
('Dr. Pravin Patel', 12, '9876500068', 'pravin.patel@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Bariatric Surgery'), '$2b$10$En3GZ.9LEpZIuG90M3GORu1vNASij9AVsxM73BKlBkhg.RPR6fnOK', '12:00 AM to 12:00 PM'),
('Dr. Mahendra Shah', 15, '9876500069', 'mahendra.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Bariatric Surgery'), '$2b$10$huGEtitX2FmYuPAtG0bE9uMzpt3rT/5CESuGRfbrqzPlQfyqYmLE.', '12:00 PM to 12:00 AM'),

-- SPINE SURGERY (2)
('Dr. Ajit Mehta', 11, '9876500070', 'ajit.mehta@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Spine Surgery'), '$2b$10$7ZfoPYIgL/gqzoVFZtq9pOOhOP6odK/L42iiJ/g5XNRCcEyw1uYDW', '12:00 AM to 12:00 PM'),
('Dr. Ramesh Desai', 13, '9876500071', 'ramesh.desai@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Spine Surgery'), '$2b$10$De2xg5iWBAqnrcjZ4h8lTug91xJDtWzfM6OMUM6zvD2J9ZLFxOOiS', '12:00 PM to 12:00 AM'),

-- PLASTIC SURGERY (2)
('Dr. Chirag Patel', 9, '9876500072', 'chirag.patel@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Plastic & Reconstructive Surgery'), '$2b$10$gcVmllLMeOJnF/tDBcsHq..C2HS2u/xI2dhV8e1eeQDm6nJ/WfFne', '12:00 AM to 12:00 PM'),
('Dr. Deepak Shah', 10, '9876500073', 'deepak.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Plastic & Reconstructive Surgery'), '$2b$10$En3GZ.9LEpZIuG90M3GORu1vNASij9AVsxM73BKlBkhg.RPR6fnOK', '12:00 PM to 12:00 AM'),

-- NEONATOLOGY (2)
('Dr. Hiral Mehta', 8, '9876500074', 'hiral.mehta@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Neonatology'), '$2b$10$huGEtitX2FmYuPAtG0bE9uMzpt3rT/5CESuGRfbrqzPlQfyqYmLE.', '12:00 AM to 12:00 PM'),
('Dr. Sneha Desai', 7, '9876500075', 'sneha.desai@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Neonatology'), '$2b$10$7ZfoPYIgL/gqzoVFZtq9pOOhOP6odK/L42iiJ/g5XNRCcEyw1uYDW', '12:00 PM to 12:00 AM'),

-- RADIOLOGY (2)
('Dr. Anil Patel', 12, '9876500076', 'anil.patel@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Radiology'), '$2b$10$De2xg5iWBAqnrcjZ4h8lTug91xJDtWzfM6OMUM6zvD2J9ZLFxOOiS', '12:00 AM to 12:00 PM'),
('Dr. Nitin Shah', 10, '9876500077', 'nitin.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Radiology'), '$2b$10$gcVmllLMeOJnF/tDBcsHq..C2HS2u/xI2dhV8e1eeQDm6nJ/WfFne', '12:00 PM to 12:00 AM'),

-- LABORATORY MEDICINE (2)
('Dr. Jay Mehta', 11, '9876500078', 'jay.mehta@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Laboratory Medicine'), '$2b$10$En3GZ.9LEpZIuG90M3GORu1vNASij9AVsxM73BKlBkhg.RPR6fnOK', '12:00 AM to 12:00 PM'),
('Dr. Kiran Desai', 9, '9876500079', 'kiran2.desai@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Laboratory Medicine'), '$2b$10$huGEtitX2FmYuPAtG0bE9uMzpt3rT/5CESuGRfbrqzPlQfyqYmLE.', '12:00 PM to 12:00 AM'),

-- PATHOLOGY (2)
('Dr. Manoj Patel', 13, '9876500080', 'manoj.patel@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Pathology'), '$2b$10$7ZfoPYIgL/gqzoVFZtq9pOOhOP6odK/L42iiJ/g5XNRCcEyw1uYDW', '12:00 AM to 12:00 PM'),
('Dr. Rajesh Shah', 11, '9876500081', 'rajesh2.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Pathology'), '$2b$10$De2xg5iWBAqnrcjZ4h8lTug91xJDtWzfM6OMUM6zvD2J9ZLFxOOiS', '12:00 PM to 12:00 AM'),

-- PHYSIOTHERAPY (2)
('Dr. Vivek Mehta', 8, '9876500082', 'vivek.mehta@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Physiotherapy'), '$2b$10$gcVmllLMeOJnF/tDBcsHq..C2HS2u/xI2dhV8e1eeQDm6nJ/WfFne', '12:00 AM to 12:00 PM'),
('Dr. Mehul Desai', 7, '9876500083', 'mehul.desai@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Physiotherapy'), '$2b$10$En3GZ.9LEpZIuG90M3GORu1vNASij9AVsxM73BKlBkhg.RPR6fnOK', '12:00 PM to 12:00 AM'),

-- REHABILITATION MEDICINE (2)
('Dr. Tapan Patel', 9, '9876500084', 'tapan.patel@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Rehabilitation Medicine'), '$2b$10$huGEtitX2FmYuPAtG0bE9uMzpt3rT/5CESuGRfbrqzPlQfyqYmLE.', '12:00 AM to 12:00 PM'),
('Dr. Paresh Shah', 10, '9876500085', 'paresh.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Rehabilitation Medicine'), '$2b$10$7ZfoPYIgL/gqzoVFZtq9pOOhOP6odK/L42iiJ/g5XNRCcEyw1uYDW', '12:00 PM to 12:00 AM'),

-- TRANSPLANT (2 EACH)
('Dr. Harish Mehta', 14, '9876500086', 'harish.mehta@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Liver Transplant'), '$2b$10$De2xg5iWBAqnrcjZ4h8lTug91xJDtWzfM6OMUM6zvD2J9ZLFxOOiS', '12:00 AM to 12:00 PM'),
('Dr. Kunal Desai', 12, '9876500087', 'kunal2.desai@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Liver Transplant'), '$2b$10$gcVmllLMeOJnF/tDBcsHq..C2HS2u/xI2dhV8e1eeQDm6nJ/WfFne', '12:00 PM to 12:00 AM'),

('Dr. Jitesh Patel', 13, '9876500088', 'jitesh.patel@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Kidney Transplant'), '$2b$10$En3GZ.9LEpZIuG90M3GORu1vNASij9AVsxM73BKlBkhg.RPR6fnOK', '12:00 AM to 12:00 PM'),
('Dr. Suresh Shah', 11, '9876500089', 'suresh.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Kidney Transplant'), '$2b$10$huGEtitX2FmYuPAtG0bE9uMzpt3rT/5CESuGRfbrqzPlQfyqYmLE.', '12:00 PM to 12:00 AM'),

('Dr. Rohan Mehta', 12, '9876500090', 'rohan.mehta@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Heart Transplant'), '$2b$10$7ZfoPYIgL/gqzoVFZtq9pOOhOP6odK/L42iiJ/g5XNRCcEyw1uYDW', '12:00 AM to 12:00 PM'),
('Dr. Bharat Desai', 10, '9876500091', 'bharat.desai@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Heart Transplant'), '$2b$10$De2xg5iWBAqnrcjZ4h8lTug91xJDtWzfM6OMUM6zvD2J9ZLFxOOiS', '12:00 PM to 12:00 AM'),

('Dr. Nikhil Patel', 11, '9876500092', 'nikhil.patel@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Lung Transplant'), '$2b$10$gcVmllLMeOJnF/tDBcsHq..C2HS2u/xI2dhV8e1eeQDm6nJ/WfFne', '12:00 AM to 12:00 PM'),
('Dr. Tejas Shah', 9, '9876500093', 'tejas.shah@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='Lung Transplant'), '$2b$10$En3GZ.9LEpZIuG90M3GORu1vNASij9AVsxM73BKlBkhg.RPR6fnOK', '12:00 PM to 12:00 AM'),
('Dr. Ramesh Gupta', 10, '9876500094', 'ramesh.gupta@nexora.com',
 (SELECT specialization_id FROM SPECIALIZATION WHERE name='General Surgery'), '$2b$10$En3GZ.9LEpZIuG90M3GORu1vNASij9AVsxM73BKlBkhg.RPR6fnOK', '4:00 PM to 12:00 AM');
